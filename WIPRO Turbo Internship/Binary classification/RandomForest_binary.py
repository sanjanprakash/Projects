...
hyperparameters = {'randomforestclassifier__max_depth' : range(3,1,-1),'randomforestclassifier__max_features' : ['sqrt','auto','log2',None], 'randomforestclassifier__n_estimators' : range(1,10,1)}	#Choosing the hyperparameters that are to be tuned
...
joblib.dump(clf,'RandomForest_binary_classifier.pkl')									#Storing the model, to be used later

#To load the model and test it on another test set
#clf2 = joblib.load('RandomForest_binary_classifier.pkl')
