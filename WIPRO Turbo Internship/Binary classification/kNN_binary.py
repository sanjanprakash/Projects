...
hyperparameters = {'kneighborsclassifier__weights' : ['uniform','distance'],'kneighborsclassifier__algorithm' : ['ball_tree','brute','kd_tree','auto'],'kneighborsclassifier__leaf_size' : range(5,35,5)}	#Choosing the hyperparameters that are to be tuned
...
joblib.dump(clf,'kNN_binary_classifier.pkl')									#Storing the model, to be used later

#To load the model and test it on another test set
#clf2 = joblib.load('kNN_binary_classifier.pkl')
