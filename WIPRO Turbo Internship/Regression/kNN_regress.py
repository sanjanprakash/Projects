...
pipeline = make_pipeline(preprocessing.StandardScaler(),KNeighborsRegressor(n_neighbors = 2))
#print pipeline.get_params()											#Listing out the hyperparameters that can be fine-tuned
hyperparameters = {'kneighborsregressor__weights' : ['uniform','distance'],'kneighborsregressor__algorithm' : ['ball_tree','kd_tree','brute','auto']}
...
print "RMSE : ",rmse
joblib.dump(clf, 'kNN_regressor.pkl')			

#To load the model and test it on another test set
#clf2 = joblib.load('kNN_regressor.pkl')
