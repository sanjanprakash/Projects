...
hyperparameters = {'gradientboostingclassifier__learning_rate' : [0.1,1,10], 'gradientboostingclassifier__n_estimators' : [10,15,20],'gradientboostingclassifier__max_depth' : [5,4,3],'gradientboostingclassifier__max_features' : ['auto','log2'],'gradientboostingclassifier__min_samples_split' : [2,3,4]}	#Choosing the hyperparameters that are to be tuned
...
joblib.dump(clf, 'GradientBoost_multi_classifier.pkl')									#Storing the model, to be used later

#To load the model and test it on another test set
#clf2 = joblib.load('GradientBoost_multi_classifier.pkl')
